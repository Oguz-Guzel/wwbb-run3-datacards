...
law run CombineDatacards --version v1.2.4-2023-mvaEval  --datacards $DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_boosted_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_boosted_2023BPix.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_resolved1b_2023.txt',,$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_resolved1b_2023BPix.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_resolved2b_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_resolved2b_2023BPix.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_VBF_boosted_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_VBF_boosted_2023BPix.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_VBF_resolved_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_VBF_resolved_2023BPix.txt'

# copy the combined datacard
output_path=$(law run CombineDatacards --version v1.2.4-2023-mvaEval  --datacards $DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_boosted_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_boosted_2023BPix.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_resolved1b_2023.txt',,$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_resolved1b_2023BPix.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_resolved2b_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_resolved2b_2023BPix.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_VBF_boosted_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_VBF_boosted_2023BPix.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_VBF_resolved_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_VBF_resolved_2023BPix.txt' --print-out 0 | grep -o 'file://.*' | sed 's|file://||')

cp "$output_path" $DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_datacard.txt'

# combine 2023 pre-BPix datacards
law run CombineDatacards --version v1.2.4-2023-mvaEval  --datacards $DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_boosted_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_resolved1b_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_resolved2b_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_VBF_boosted_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_VBF_resolved_2023.txt'

# copy the combined datacard
output_path=$(law run CombineDatacards --version v1.2.4-2023-mvaEval  --datacards $DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_boosted_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_resolved1b_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_resolved2b_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_VBF_boosted_2023.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/DL_VBF_resolved_2023.txt' --print-out 0 | grep -o 'file://.*' | sed 's|file://||')

cp "$output_path" $DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_2023_datacard.txt'
...
cp "$output_path" $DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_2023BPix_datacard.txt'

# run PlotUpperLimitsAtPoint task
law run PlotUpperLimitsAtPoint --version v1.2.4-2023-mvaEval  --multi-datacards $DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_2023_datacard.txt':$DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_2023BPix_datacard.txt':$DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_datacard.txt' --datacard-names "2023","2023BPix","Combined" --workers 16

# copy the upper limit plot
output_path=$(law run PlotUpperLimitsAtPoint --version v1.2.4-2023-mvaEval  --multi-datacards $DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_2023_datacard.txt':$DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_2023BPix_datacard.txt':$DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_datacard.txt' --datacard-names "2023","2023BPix","Combined" --workers 16 --print-out 0 | grep -o 'file://.*' | sed 's|file://||')

cp "$output_path" $DATACARD_DIR'output/v1.2.4-2023-mvaEval/2023_upper_limits_at_point.pdf'

# run pulls and impacts
law run PlotPullsAndImpacts --version v1.2.4-2023-mvaEval --datacards $DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_2023_datacard.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_2023BPix_datacard.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_datacard.txt' --campaign '2023' 

# copy the pulls and impacts plot
output_path=$(law run PlotPullsAndImpacts --version v1.2.4-2023-mvaEval --datacards $DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_2023_datacard.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_2023BPix_datacard.txt',$DATACARD_DIR'output/v1.2.4-2023-mvaEval/combined_datacard.txt' --campaign '2023'  --print-out 0 | grep -o 'file://.*' | sed 's|file://||')
